...
public class Inventario {
	// atributos
	/**
	 * El inventario, contiene String (Inventario elegido), map de String (nombre
	 * item) y el item
	 */
	HashMap<String, HashMap<String, Item>> inventario;

	/**
	 * Constructor de Inventario, inicializa el inventario y añade las 2 categorias
	 * que hay, Items y peces
	 */
	public Inventario() {
	...
	public void setInventario(HashMap<String, HashMap<String, Item>> inventario) {
	 ...
	 * Getter de los items
	 * 
	 * @return Una lista de todos los items dentro del inventario, sumando Items y
	 *         Peces
	 */
